      ...
      <div id="qt-9" className="mt-5">
        ...
        <RadioGroup className="flex flex-col gap-4" value={pressao} onValueChange={setPressao}>
          {[
            ...
            <FieldLabel key={value} htmlFor={`faixa-${value}`} className="input-default checked-border cursor-pointer">
      ...
      <div id="qt-10" className="mt-5">
        ...
        <RadioGroup className="flex flex-col gap-4" value={frequencia} onValueChange={setFrequencia}>
          {[
            ...
            <FieldLabel key={value} htmlFor={`freq-${value}`} className="input-default checked-border cursor-pointer">
              <Field orientation="vertical">
                <FieldContent>
                  <div className="flex flex-row items-center gap-2">
                    <Image alt="" src={img} width={30} height={30} />
